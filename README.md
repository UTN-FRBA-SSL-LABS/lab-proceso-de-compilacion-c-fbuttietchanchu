...
> **R:** Porque el programa.i es el codigo en C expandido.
...
> **R:** Porque los comentarion se eliminan completamente. 
...
> **R:** El primero no devuelve nada y el segundo devuelve: printf("[DEBUG] %s\n", ("Iniciando main"));
...
> **R:** Esas lineas comunican la linea y el archivo de donde viene la declaracion. Proviene del archivo stdio.h.
...
> **R:** Porque en programa.o no esta definido, en cambio en matematica.o si está definido (T=texto/codigo)
...
> **R:** Quedan porque esas funciones no estan en el programa, sino en librerias del sistema. Las resuelve el sistema cuando se ejecuta el programa.
...
> **R:** La macro es solo un reemplazo de texto y desaparece en el preprocesamiento.
La funcion es código real que se ejecuta y pasa por la compilacion.
Solo la funcion tiene verificacion de tipos.
...
> **R:** Un simbolo tipo T es codigo (funciones) y esta en la seccion text.
Un simbolo tipo D es un dato, variable global con valor inicial y esta en la seccion data.
...
> **R:**  ntdll.dll => /c/WINDOWS/SYSTEM32/ntdll.dll (0x7ff85b040000)
        ntdll.dll => /c/Windows/SysWOW64/ntdll.dll (0x77870000)
        wow64.dll => /c/WINDOWS/System32/wow64.dll (0x7ff8591a0000)
        wow64base.dll => /c/WINDOWS/System32/wow64base.dll (0x7ff859640000)
        wow64win.dll => /c/WINDOWS/System32/wow64win.dll (0x7ff859d90000)
        wow64con.dll => /c/WINDOWS/System32/wow64con.dll (0x7ff85a9d0000)

¿Por qué `libc` no hubo que especificarla explícitamente al enlazar con `gcc`?

> **R:** Porque gcc la agrega automaticamente al enlazar. Ya viene configurado para incluir la libreria estandar de C (libc) sin que tengamos que escribirla.
